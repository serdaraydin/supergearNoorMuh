...
import AddToBtn from "../ui/AddToBtn";
                ...
                <div>
                  {productData?.images?.map((item, index) => (
                    <img
                      ...
                      alt="img"
                      key={index}
                      className={`w-24 cursor-pointer opacity-80 hover:opacity-100 ${
                        imgUrl === item &&
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between">
                  <PriceTag
                    ...
                    className="text-xl"
                  />
                  <div className="text-base items-center gap-1">
                ...
                <p className="flex items-center">
                  ...
                  people area visiting right now
                </p>
                <p>
                  You are saving
