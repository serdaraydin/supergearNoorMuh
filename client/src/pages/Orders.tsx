      ...
      {loading ? (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm max-w-[600px] tracking-wide text-gray-500">
            ...
            saepe nisi rerum rem impedit ut blanditiis doloremque sint, aliquam
            soluta iste itaque porro excepturi eius assumenda, ad quia obcaecati
            error odit labore a beatae alias. Beatae, similique? Amet, veniam
            in!
          </p>
                              ...
                              >
                                ...
                                >
                                  <img
                                    src={item.images[0]}
                                    alt="Product Image"
                                    className="h-full w-full object-cover origin-center hover:scale-110 duration-300"
                                  />
                                </Link>
