...
const Highlights = () => {
  const [higlightsData, setHighlightsData] = useState([]);
  ...
  return (
    <Container className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
      {higlightsData.map((item: HighlightsType) => (
        <div
          key={item._id}
