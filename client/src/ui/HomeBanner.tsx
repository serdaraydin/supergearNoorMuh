    ...
    <Container className="relative py-5 overflow-hidden">
      <div className="relative">
        ...
        <div
          ...
          <h2 className="text-xl md:text-4xl lg:text-6xl text-whiteText/90 max-w-[250px] font-bold">
            Mi Air Purifier
          </h2>
          <p className=" text-base md:text-lg font-semibold leading-6 text-whiteText">
