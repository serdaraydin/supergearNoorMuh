    ...
    <Container className="py-5 text-white">
      <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-16">
        <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-10">
          ...
          <div className="text-start flex-1">
            ...
            <p className="text-start *:mt-6 max-w-3xl text-base mt-3 leading-6 text-gray-300">
              ...
              Obcaecati, enim velit, eum sunt, explicabo magnam sequi veritatis
              magni quidem provident beatae. Recusandae ea laudantium numquam
              eaque, voluptates sapiente voluptate aperiam quae optio ad nostrum
              exercitationem aliquid cumque. Libero aspernatur illum, harum modi
              quaerat quia asperiores voluptatum saepe ut delectus nisi!
            </p>
          </div>
        </div>
        <div className="mt-10 flex items-center gap-x-5 px-4">
          <button
            onClick={() =>
              toast.error("Edit profile option avaible to pro version!")
            }
