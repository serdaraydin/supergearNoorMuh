      ...
      >
        <div className="border-b border-b-white/10 pb-5">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-400">
            You need to required information to get register with us.
          </p>
        </div>
        <div className="border-b border-b-white/10 pb-5">
          <div
            className="mt-5
               grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6"
          >
            <div className="sm:col-span-4">
              ...
              <input
                type="email"
                name="email"
                className="block w-full rounded-md border-0 bg-white/5 gap-y-1.5 px-4 outline-none text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-skyText sm:text-sm sm:leading-6 mt-2"
              />
            </div>
            <div className="sm:col-span-4">
